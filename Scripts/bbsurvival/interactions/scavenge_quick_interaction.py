    ...
    def _give_scavenge_rewards(self, sim_info: SimInfo) -> None:
        ...
        if seed_dice_roll < seed_chance:
            ...
            for to_add_seed in to_add_seeds:
                BBSimInventoryUtils.create_in_inventory(sim_info, to_add_seed)
        else:
        ...
        if fruit_dice_roll < fruit_chance:
            ...
            for to_add_fruit in to_add_fruits:
                BBSimInventoryUtils.create_in_inventory(sim_info, to_add_fruit)
        else:
        ...
        if animal_definition_ids:
            ...
            if animal_dice_roll < animal_chance:
                ...
                for to_add_animal in to_add_animals:
                    BBSimInventoryUtils.create_in_inventory(sim_info, to_add_animal)
            else:
        ...
        if ingredient_dice_roll < ingredient_chance:
            ...
            for to_add_ingredient in to_add_ingredients:
                BBSimInventoryUtils.create_in_inventory(sim_info, to_add_ingredient)
        else:
        ...
        if mineral_dice_roll < mineral_chance:
            ...
            for to_add_mineral in to_add_minerals:
                BBSimInventoryUtils.create_in_inventory(sim_info, to_add_mineral)
        else:
