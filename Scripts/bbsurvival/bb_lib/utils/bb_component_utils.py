...
class BBComponentUtils:
    ...
    @staticmethod
    def get_component(component_container: Union[Sim, GameObject, ComponentContainer], component_type: BBComponentType, return_type: Type[BBExpectedReturnType] = Component) -> Union[BBExpectedReturnType, None]:
